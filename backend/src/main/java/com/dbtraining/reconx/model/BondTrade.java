...
/**Returns the unique identifier of this trade. @return immutable trade reference used as the trade's natural key. */
    ...
    /**
     * Compares this trade with another object for logical equality.
     *
     * @param o object to compare with this trade.
     * @return {@code true} if both objects represent the same trade;
    ...
    @Override public boolean equals(Object o) {
        ...
        /**
     * Computes the hash code for this trade.
     *
     * @return hash code derived from the trade's natural key.
     */
    ...
    /**
     * Returns a human-readable summary of this trade.
     *
     * @return concise string suitable for logging and debugging.
     */
